...
"WSELECT  projects.title, SUM (pledges.amount - projects.funding_goal) FROM pledges
JOIN projects ON projects.id = pledges.project_id WHERE pledges.amount > projects.funding_goal
